# Auditoria curta - La Granja de Gràcia

Data: 2026-07-17

## Context

- Restaurant: La Granja de Gràcia
- Zona: Gràcia, Barcelona
- Segment: restaurant de mercat / menú del dia / tapes
- Web: https://www.lagranjadegracia.com/
- Google Maps: pendent de revisar
- Contacte public: info@lagranjadegracia.com / 931 78 19 69
- Font: https://www.lagranjadegracia.com/

## Observacio inicial

Web amb menu del dia, plats de mercat, contacte i horaris; bon candidat per treballar cerques de menu i restaurant de barri.
...
Hola, he estat mirant la presencia de La Granja de Gràcia a Google i crec que hi ha algunes millores concretes per fer que la fitxa transmeti millor i generi mes accions. No parlo de web nova ni anuncis: nomes Google Maps, posts, ressenyes i conversio local. Et puc enviar una auditoria curta amb 5 punts?
