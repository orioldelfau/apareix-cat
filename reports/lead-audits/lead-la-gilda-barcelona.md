...
- Segment: tapes i vins
- Web: https://www.lagildabcn.com/
- Google Maps: pendent de revisar
- Contacte public: +34 931 180 354
- Font: https://www.lagildabcn.com/

## Observacio inicial

Restaurant de tapes amb horaris, fotos i mapa a la web; bon candidat per auditar fotos, ressenyes i consistencia local.
...
Hola, he estat mirant la presencia de La Gilda a Google i crec que hi ha algunes millores concretes per fer que la fitxa transmeti millor i generi mes accions. No parlo de web nova ni anuncis: nomes Google Maps, posts, ressenyes i conversio local. Et puc enviar una auditoria curta amb 5 punts?
