...
- Segment: restaurant mediterrani / menú del dia / terrassa
- Web: https://patronrestaurante.com/restaurante-con-menu-del-dia/
- Google Maps: pendent de revisar
- Contacte public: booking@patron-restaurant.com / +34 934 14 66 22
- Font: https://patronrestaurante.com/restaurante-con-menu-del-dia/

## Observacio inicial

Pagina específica de menú del dia amb FAQ i reserves; angle fort per Google Maps, posts setmanals i cerques de migdia prop de Diagonal.

## Oportunitat comercial

El menu de migdia es un angle fort per captar cerques locals recurrents. Google Maps hauria de mostrar activitat, proposta clara i accio rapida per reservar o trucar.
...
Hola, he estat mirant la presencia de Patrón a Google i crec que hi ha algunes millores concretes per fer que la fitxa transmeti millor i generi mes accions. No parlo de web nova ni anuncis: nomes Google Maps, posts, ressenyes i conversio local. Et puc enviar una auditoria curta amb 5 punts?
