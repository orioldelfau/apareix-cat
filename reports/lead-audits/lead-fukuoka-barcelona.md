# Auditoria curta - Fukuoka BCN

Data: 2026-07-17

## Context

- Restaurant: Fukuoka BCN
- Zona: Gràcia, Barcelona
- Segment: restaurant japonès / fusió brasilera / menú del dia
...
- Font: https://fukuokabcn.es/nuestra-carta

## Observacio inicial

Web amb carta, menu del dia, reserva i contacte; bon angle per posts recurrents de menu i cerques de sushi/japonès a Gràcia.
...
Hola, he estat mirant la presencia de Fukuoka BCN a Google i crec que hi ha algunes millores concretes per fer que la fitxa transmeti millor i generi mes accions. No parlo de web nova ni anuncis: nomes Google Maps, posts, ressenyes i conversio local. Et puc enviar una auditoria curta amb 5 punts?
